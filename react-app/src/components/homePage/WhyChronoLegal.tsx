        ...
        <div style={{ backgroundColor: "white", padding: "0px 40px 50px" }}>
          <div className="wrapper d-flex flex-lm-row flex-md-block">
            ...
            <div className="Content" style={{ marginLeft: "20px" }}>
              ...
              >
                Because you should focus on the strategic work you do best and
                let us handle the rest. Turn contracts around in a day when
                needed and refocus the time, energy, and effort you currently
                spend on contract review on your core strategic activities.
              </p>
              <h2
                style={{
                  color: "#ec720b",
              ...
              >
                ...
                avoid missing deadlines, and mitigate high-risk contractual
