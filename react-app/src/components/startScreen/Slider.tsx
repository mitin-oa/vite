    ...
    <div className="slider-container">
      <Slider {...settings}>
        <div className="slider-card">
          ...
          <p className="slider-card__text">James K., General Counsel</p>
        </div>
        <div className="slider-card">
          <p className="slider-card__text">
          ...
          <p className="slider-card__text">Oren S., CEO, Founder</p>
        </div>
        <div className="slider-card">
          <p className="slider-card__text">
          ...
          <p className="slider-card__text">Mary L., SVP, Procurement</p>
        </div>
        <div className="slider-card">
          <p className="slider-card__text">
          ...
          <p className="slider-card__text">Diana G., Chief Legal Officer</p>
        </div>
        <div className="slider-card">
          <p className="slider-card__text">
          ...
          <p className="slider-card__text">Mike M., VP of Sales</p>
        </div>
      </Slider>
    </div>
  );
